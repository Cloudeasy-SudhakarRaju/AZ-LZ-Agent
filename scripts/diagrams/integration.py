...
from diagrams.azure.analytics import StreamAnalyticsJobs as StreamAnalytics
...
with Diagram("Azure - Integration", show=False, outformat="png", filename="docs/diagrams/integration", graph_attr=GRAPH_ATTR, node_attr=NODE_ATTR):
