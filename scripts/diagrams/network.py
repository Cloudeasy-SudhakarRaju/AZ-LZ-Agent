...
with Diagram("Azure - Network", show=False, outformat="png", filename="docs/diagrams/network", graph_attr=GRAPH_ATTR, node_attr=NODE_ATTR):
    ...
    with Cluster("Identity / Control"):
        ...
        mdef = Defender("Defender for Cloud")
