...
from diagrams.azure.storage import DataLakeStorage as DataLake, BlobStorage as Blob, QueuesStorage as Queue, TableStorage as Table
...
with Diagram("Azure - Data", show=False, outformat="png", filename="docs/diagrams/data", graph_attr=GRAPH_ATTR, node_attr=NODE_ATTR):
